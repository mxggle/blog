...
<pre class="hljs"><code v-pre>'I\'m \&quot;OK\&quot;!'
</code></pre>
</li>
<li>
<p>r''表示''内部的字符串默认不转义</p>
<pre class="hljs"><code v-pre>&gt;&gt;&gt; print('\\\t\\')
\       \
&gt;&gt;&gt; print(r'\\\t\\')
\\\t\\
</code></pre>
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; print('''line1
... line2
... line3''')
line1
line2
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; ord('A')
65
&gt;&gt;&gt; ord('中')
20013
&gt;&gt;&gt; chr(66)
...
<pre class="hljs"><code v-pre><span class="hljs-comment"># encode</span>
...
<pre class="hljs"><code v-pre><span class="hljs-comment">#!/usr/bin/env python3</span>
...
<pre class="hljs"><code v-pre> print('%2d-%02d' % (3, 1)) # 3-01
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; 'Hello, {0}, 成绩提升了 {1:.1f}%'.format('小明', 17.125)
'Hello, 小明, 成绩提升了 17.1%'
</code></pre>
</li>
</ul>
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; classmates = ['Michael', 'Bob', 'Tracy']
&gt;&gt;&gt; classmates
['Michael', 'Bob', 'Tracy']
&gt;&gt;&gt; len(classmates)
3
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; classmates.append('Adam')
&gt;&gt;&gt; classmates
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; classmates.insert(1, 'Jack')
&gt;&gt;&gt; classmates
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; classmates.pop()
'Adam'
&gt;&gt;&gt; classmates
...
<pre class="hljs"><code v-pre>names = ['Michael', 'Bob', 'Tracy']
for name in names:
    print(name)
</code></pre>
</li>
...
<pre class="hljs"><code v-pre>sum = 0
n = 99
while n &gt; 0:
    sum = sum + n
    n = n - 2
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; d = {'Michael': 95, 'Bob': 75, 'Tracy': 85}
&gt;&gt;&gt; d['Michael']
95
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; 'Thomas' in d
False
</code></pre>
</li>
<li>
<p>通过dict提供的get()方法，如果key不存在，可以返回None，或者自己指定的value：</p>
<pre class="hljs"><code v-pre>&gt;&gt;&gt; d.get('Thomas')
&gt;&gt;&gt; d.get('Thomas', -1)
-1
</code></pre>
...
<li>
<p>删除元素</p>
<pre class="hljs"><code v-pre>&gt;&gt;&gt; d.pop('Bob')
75
&gt;&gt;&gt; d
{'Michael': 95, 'Tracy': 85}
</code></pre>
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; s = set([1, 1, 2, 2, 3, 3])
&gt;&gt;&gt; s
{1, 2, 3}
</code></pre>
</li>
...
<pre class="hljs"><code v-pre>&gt;&gt;&gt; a = abs # 变量a指向abs函数
&gt;&gt;&gt; a(-1) # 所以也可以通过a调用abs函数
1
</code></pre>
</li>
...
<pre class="hljs"><code v-pre>def my_abs(x):
    if x &gt;= 0:
        return x
    else:
        return -x
...
<pre class="hljs"><code v-pre>def nop():
pass
</code></pre>
</li>
<li>
...
<li>
<p>默认参数</p>
<pre class="hljs"><code v-pre>def power(x, n=2):
    s = 1
    while n &gt; 0:
        n = n - 1
        s = s * x
...
<pre class="hljs"><code v-pre>def calc(*numbers):
    sum = 0
    for n in numbers:
        sum = sum + n * n
    return sum
...
<pre class="hljs"><code v-pre>def person(name, age, **kw):
...
<li>
<p>命名关键字参数</p>
<pre class="hljs"><code v-pre>def person(name, age, *, city, job):
