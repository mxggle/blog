<template><div class="markdown-container"><h1>MacDown</h1>
<p><img src="http://macdown.uranusjr.com/static/images/logo-160.png" alt="MacDown logo"></p>
...
<pre class="hljs"><code>* This two-line bullet 
won't break
...
<p>Here is the code:</p>
<pre class="hljs"><code>* Lists must be preceded by a blank line (or block element)
...
<p>Here is the code:</p>
<pre class="hljs"><code>&gt; Angle brackets `&gt;` are used for block quotes.  
...
<pre class="hljs"><code>print('Hello world!')
</code></pre>
